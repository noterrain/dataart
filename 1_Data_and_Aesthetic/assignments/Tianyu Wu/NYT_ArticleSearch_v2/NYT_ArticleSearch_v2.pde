...
String apiKey = "4985b4f888a5bea1e61ddf95730c65ee:0:66988207";
...
void setup() {
  ...
  //int[] monkeyCounts = doASearchYears("pollution", 1950, 2010);
  //int[] monkeyCounts = doASearchYears("air pollution", 1950, 2010);
  
  
 //get something important here for that
 String[] rows = loadStrings("data/Workbook1.csv");
  monkeyCounts = new int[rows.length];
  //println(numbers.length);
  for(int i =0; i<rows.length; i++) monkeyCounts[i] = int(rows[i]);
...
//  PrintWriter writer = createWriter("data/Workbook1");
...
//  
 ...
 // ASResult osama = doASearch("bin laden", "20110502", "20110502");
  ...
  //for(int i =0; i < keyWords.size(); i++) {
   ...
   //println(keyWord.getString("name"));
  //}
